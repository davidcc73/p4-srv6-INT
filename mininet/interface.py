...
def low_load_test(net, routing):
    ...
    max_receiver_timeout = max(receiver_timeout["Message"])
    #See max sleep time between flows types to create
    max_iteration_sleep = max(iteration_sleep["Message"])
...
def medium_load_test(net, routing):
    ...
    #See max sleep time for receiver to wait for packets
    max_receiver_timeout = max(receiver_timeout["Message"], receiver_timeout["Audio"], receiver_timeout["Video"])
    #See max sleep time between flows types to create
...
def high_load_test(net, routing):
    ...
    for iteration in range(1, num_iterations + 1):
        ...
        #-------------Start the receive script on the destination hosts
        receive_packet_script(h1_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h2_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h2_2, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h3_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h5_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h7_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h7_2, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h7_3, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h8_1, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h8_2, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h8_3, file_results, iteration, max_receiver_timeout)
        receive_packet_script(h8_4, file_results, iteration, max_receiver_timeout)
